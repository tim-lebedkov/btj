...
Expected directory structure:
    ...
    btj.properties - build settings
        project.type=command-line|service|library|web - type of the project. 
            The default value is "command-line". 
            command-line - command line based application
            service - Windows service
            library - a library
            web - JEE web application
    ...
    (optional) web/ - this directory corresponds to the contents of the .war 
        file and is only used for the projects of the type "web".
